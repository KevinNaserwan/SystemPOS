<svg preserveAspectRatio='none' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <path
        ...
        fill='url(#paint0_linear_96_170)' />
    <defs>
        <linearGradient id='paint0_linear_96_170' x1={5} y1={7} x2={18} y2={18} gradientUnits='userSpaceOnUse'>
            <stop stopColor='#42047E' />
            <stop offset={1} stopColor='#07F49E' />
        </linearGradient>
    </defs>
</svg>
